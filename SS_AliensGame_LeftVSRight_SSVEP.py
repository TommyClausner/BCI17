...
# screen = pygame.display.set_mode((ScreenWidth, ScreenHeight))
# clock = pygame.time.Clock()
# # pygame.draw.line(screen, (255, 0, 0), (0, 300), (ScreenWidth, 300), 1)
# alien1 = Alien(screen, 300)
# pygame.display.flip()
#
# alien1.move()
#
...
# screen.fill((0, 0, 0))
#
# pygame.draw.circle(screen, (0,255,0), (300, 300), 6)


## TODO def dist_L2(Alien, Bullet)
# Only need first, because force field!